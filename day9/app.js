...
function changeWeatherUI(weather) {
    ...
    if(temp <= 30){document.body.className = 'hot'}
	if(temp <= 25){document.body.className = 'cool'}
	if(temp <= 22 ){document.body.className = 'cold'}
	if(temp <= 19 ){document.body.className = 'warm'}
